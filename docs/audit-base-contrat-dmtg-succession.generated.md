...
| pages | src/pages/settings/BaseContrat.tsx:23 | base_contrat_overrides | } from '@/utils/cache/baseContratOverridesCache'; |
| pages | src/pages/settings/BaseContrat.tsx:208 | CATALOG | return CATALOG.filter((product) => { |
| pages | src/pages/settings/BaseContrat.tsx:243 | CATALOG | () => CATALOG.filter((product) => !isProductClosed(product.id, overrides, today)).length, |
| pages | src/pages/settings/BaseContrat.tsx:246 | CATALOG | const closedCount = CATALOG.length - activeCount; |
| pages | src/pages/settings/BaseContrat.tsx:274 | CATALOG | {CATALOG.length} produits - {activeCount} ouverts - {closedCount} clôturés |
| pages | src/pages/settings/BaseContrat.tsx:364 | getRules | const rules = getRules(product.id, togglePPPM); |
...
| other | src/utils/cache/baseContratOverridesCache.ts:14 | base_contrat_overrides | const TABLE = 'base_contrat_overrides'; |
| other | src/utils/cache/baseContratOverridesCache.ts:32 | base_contrat_overrides | console.error('[baseContratOverridesCache] fetch error:', error.message); |
| other | src/utils/cache/baseContratOverridesCache.ts:55 | base_contrat_overrides | throw new Error(`[baseContratOverridesCache] upsert error: ${error.message}`); |

## Produits / régimes exposés
| Produit | Famille | Audience | Blocs | Sources | Moyenne/faible | Score patrimonial | Score dev senior | Verdict |
|---|---|---:|---:|---:|---:|---:|---:|---|
| Assurance dépendance | Assurance prévoyance | PP | 3 | 0/3 | 0 | 3/5 | 2/5 | éditorial |
| Assurance emprunteur | Assurance prévoyance | PP | 3 | 0/3 | 0 | 3/5 | 2/5 | éditorial |
| Assurance emprunteur | Assurance prévoyance | PM | 3 | 0/3 | 1 | 3/5 | 1/5 | éditorial |
| Assurance obsèques | Assurance prévoyance | PP | 3 | 1/3 | 0 | 4/5 | 2/5 | éditorial |
| Prévoyance individuelle décès | Assurance prévoyance | PP | 3 | 1/3 | 1 | 4/5 | 2/5 | éditorial |
| Prévoyance individuelle arrêt de travail / invalidité | Assurance prévoyance | PP | 4 | 2/4 | 1 | 5/5 | 2/5 | éditorial |
| Assurance homme-clé | Assurance prévoyance | PM | 3 | 2/3 | 2 | 4/5 | 2/5 | éditorial |
| Assurance-vie | Épargne Assurance | PP | 7 | 5/7 | 1 | 5/5 | 2/5 | éditorial |
| Contrat de capitalisation | Épargne Assurance | PP | 4 | 2/4 | 0 | 5/5 | 2/5 | éditorial |
| Contrat de capitalisation | Épargne Assurance | PM | 3 | 1/3 | 2 | 3/5 | 2/5 | éditorial |
...
| Article 83 (anciens contrats "retraite entreprise") | Retraite & épargne salariale | PP | 3 | 2/3 | 3 | 4/5 | 2/5 | éditorial |
| Article 83 (anciens contrats "retraite entreprise") | Retraite & épargne salariale | PM | 3 | 1/3 | 3 | 3/5 | 2/5 | éditorial |
| Article 39 (retraite supplémentaire à prestations définies) | Retraite & épargne salariale | PP | 3 | 0/3 | 3 | 2/5 | 1/5 | non prêt |
| Article 39 (retraite supplémentaire à prestations définies) | Retraite & épargne salariale | PM | 3 | 2/3 | 3 | 4/5 | 2/5 | éditorial |
| Madelin retraite (ancien) | Retraite & épargne salariale | PP | 3 | 2/3 | 0 | 5/5 | 2/5 | éditorial |
| PEE (Plan d'épargne entreprise) | Retraite & épargne salariale | PP | 4 | 2/4 | 0 | 5/5 | 2/5 | éditorial |
| PEE (Plan d'épargne entreprise) | Retraite & épargne salariale | PM | 3 | 0/3 | 3 | 2/5 | 1/5 | non prêt |
| Intéressement | Retraite & épargne salariale | PM | 3 | 1/3 | 3 | 3/5 | 2/5 | éditorial |
| Participation | Retraite & épargne salariale | PM | 3 | 1/3 | 3 | 3/5 | 2/5 | éditorial |
| Prime de Partage de la Valeur (PPV) | Retraite & épargne salariale | PM | 3 | 1/3 | 3 | 3/5 | 2/5 | éditorial |
| PERIN assurantiel (PER individuel assurance) | Retraite & épargne salariale | PP | 7 | 5/7 | 0 | 5/5 | 2/5 | éditorial |
| PERIN bancaire (PER individuel compte-titres) | Retraite & épargne salariale | PP | 4 | 1/4 | 0 | 4/5 | 2/5 | éditorial |
| PERCOL (PER collectif) | Retraite & épargne salariale | PP | 4 | 2/4 | 0 | 5/5 | 2/5 | éditorial |
| PERCOL (PER collectif) | Retraite & épargne salariale | PM | 3 | 0/3 | 3 | 2/5 | 1/5 | non prêt |
| PERCO (ancien) | Retraite & épargne salariale | PP | 4 | 2/4 | 0 | 5/5 | 2/5 | éditorial |
| PERCO (ancien) | Retraite & épargne salariale | PM | 3 | 0/3 | 3 | 2/5 | 1/5 | non prêt |
| PERO (PER obligatoire) | Retraite & épargne salariale | PP | 3 | 1/3 | 3 | 3/5 | 2/5 | éditorial |
| PERO (PER obligatoire) | Retraite & épargne salariale | PM | 3 | 2/3 | 3 | 4/5 | 2/5 | éditorial |
| PERP (ancien) | Retraite & épargne salariale | PP | 3 | 2/3 | 0 | 5/5 | 2/5 | éditorial |
...
| Crypto-actifs | Autres | PP | 4 | 2/4 | 0 | 5/5 | 2/5 | éditorial |
| Crypto-actifs | Autres | PM | 3 | 0/3 | 0 | 3/5 | 2/5 | éditorial |
| Métaux précieux | Autres | PP | 3 | 2/3 | 0 | 5/5 | 2/5 | éditorial |
| Métaux précieux | Autres | PM | 3 | 0/3 | 0 | 3/5 | 2/5 | éditorial |
| Tontine (association tontinière) | Autres | PP | 3 | 1/3 | 3 | 3/5 | 2/5 | éditorial |
| Tontine (association tontinière) | Autres | PM | 3 | 0/3 | 0 | 3/5 | 2/5 | éditorial |
