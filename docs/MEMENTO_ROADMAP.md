...
| Assurance-vie / capitalisation                                | sous-type                 | Placements / Assurance-vie et capitalisation | `/settings/base-contrat`, `/settings/memento`                                 | Fiscalité vie/décès, rachat, transmission                | CGI, BOFiP, Code assurances                        | PR 8            | partiel/couvert          |
