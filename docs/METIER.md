...
| `/strategy` | actif, workflow prive P7 | Produire des scénarios comparatifs et projections à partir du draft audit courant, avec validation CGP, sans être encore traité comme un simulateur `/sim/*` stabilisé |
