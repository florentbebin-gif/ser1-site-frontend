...
4. **Corps** : en-tête de section optionnel (titre + méta courte) ; **pas de carte imbriquée** (les sections sont des bandes, pas des cards dans la modale) ; champs via primitives `Sim*` ; **aucun scroll horizontal** (desktop ni mobile).
