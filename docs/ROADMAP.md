...
| UX-03a.1 ✅ | Foyer & famille                                                                           | F1 ✅, UX-00b   | ✅ livré            | Page cockpit en 4 cartes F1 + `AuditDrawerXL` minimal ; rail, topbar et barre d'état conservés ; aucune donnée famille locale concurrente                                                                           |
...
| UX-03a.3 ✅ | Fiscalité déclarative                                                                     | F1/DossierAudit | ✅ livré            | Page cockpit fiscalité déclarative ; TMI seulement renseignée si donnée explicite ; aucun IR calculé, aucun hardcode fiscal, aucune optimisation réelle                                                             |
