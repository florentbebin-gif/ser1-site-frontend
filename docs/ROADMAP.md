...
Ordre recommandé : UX-00a → UX-00b → UX-01 → UX-02 → F1.1 → UX-03 → UX-03b → F2 → F3 → UX-05 →
...
Dettes interdites (détail dans `docs/AUDIT_COCKPIT.md` § 15) : aucun score sans calculabilité, aucune
