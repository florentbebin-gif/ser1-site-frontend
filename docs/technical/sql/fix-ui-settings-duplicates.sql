-- Fix: Dédoublonnage ui_settings + contrainte d'unicité
-- Date: 2026-01-31
-- Contexte: Theme Flash Fix - fiabilisation de la table ui_settings
-- Source: docs/technical/fixes/theme-flash-fix.md
