...
const tokenGroups: TokenGroup[] = [
  {
    ...
    kind: 'space',
    tokens: [
      { name: '--space-1', preview: 'var(--space-1)', value: '4 px' },
      { name: '--space-2', preview: 'var(--space-2)', value: '8 px' },
      { name: '--space-3', preview: 'var(--space-3)', value: '12 px' },
      { name: '--space-4', preview: 'var(--space-4)', value: '16 px' },
      { name: '--space-5', preview: 'var(--space-5)', value: '20 px' },
      { name: '--space-6', preview: 'var(--space-6)', value: '24 px' },
      { name: '--space-7', preview: 'var(--space-7)', value: '32 px' },
      { name: '--space-8', preview: 'var(--space-8)', value: '48 px' },
    ],
  },
  {
    title: 'Rayons',
  ...
  },
  {
    ...
    kind: 'font',
    tokens: [
      { name: '--font-size-xs', preview: 'var(--font-size-xs)', value: '10 px' },
      { name: '--font-size-sm', preview: 'var(--font-size-sm)', value: '12 px' },
      { name: '--font-size-md', preview: 'var(--font-size-md)', value: '13 px' },
      { name: '--font-size-lg', preview: 'var(--font-size-lg)', value: '15 px' },
      { name: '--font-size-xl', preview: 'var(--font-size-xl)', value: '18 px' },
      { name: '--font-size-2xl', preview: 'var(--font-size-2xl)', value: '22 px' },
      { name: '--font-size-3xl', preview: 'var(--font-size-3xl)', value: '28 px' },
    ],
  },
  {
    title: 'Mouvement',
