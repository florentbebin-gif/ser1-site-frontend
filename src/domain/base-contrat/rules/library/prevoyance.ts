  ...
  deces: [
    {
      ...
      confidence: 'moyenne',
      sources: [{ label: 'BOI-BIC-CHG-40-20-20 §100', url: 'https://bofip.impots.gouv.fr/bofip/803-PGP.html/identifiant=BOI-BIC-CHG-40-20-20-20130408' }, { label: 'Art. 38 CGI — résultat imposable', url: 'https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006302193' }],
      dependencies: ['type de contrat (indemnitaire vs forfaitaire)', 'exercice de réalisation du sinistre', 'modalités de sortie de la personne morale'],
    },
  ],
};
