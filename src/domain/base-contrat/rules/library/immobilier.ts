  ...
  constitution: [
    {
      ...
      bullets: [
        'Revenus imposés en BIC (pas en revenus fonciers).',
        'Micro-BIC sous seuil légal : abattement forfaitaire applicable (seuil révisé périodiquement — À confirmer).',
        'Régime réel : amortissements du bien et du mobilier déductibles.',
        'Statut LMNP : activité non professionnelle si recettes locatives inférieures aux seuils légaux — À confirmer.',
      ],
