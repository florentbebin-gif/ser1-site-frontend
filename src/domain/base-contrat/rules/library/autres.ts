  ...
  constitution: [
    {
      ...
      sources: [
        {
          label: 'Code des assurances — section Tontines',
          url: 'https://www.legifrance.gouv.fr/loda/id/LEGISCTA000006142811',
        },
      ],
      dependencies: [
        "statuts de l'association tontinière",
        'frais de gestion et modalités de répartition',
      ],
    },
  ],
  sortie: [
...
export function getAutresRules(productId: string, audience: Audience): ProductRules | undefined {
  switch (productId) {
    case 'tontine_pp':
      return TONTINE;
    case 'tontine_pm':
    ...
    case 'tontine':
      return audience === 'pm'
        ? buildPmLifecycleRules('mécanisme tontinier', ['tontine'])
        : TONTINE;
    ...
    case 'metaux_precieux':
      return audience === 'pm'
        ? buildPmLifecycleRules('métaux précieux', ['metaux_precieux'])
        : METAUX_PRECIEUX;
    default:
      return undefined;
  }
