...
const PERIN_ASSURANCE: ProductRules = {
  constitution: [
    ...
    },
    {
      ...
      confidence: 'elevee',
      sources: [{ label: 'Service-Public — PER individuel', url: 'https://www.service-public.fr/particuliers/vosdroits/F36526/0' }],
    },
  ],
  sortie: [
    {
  ...
  constitution: [
    {
      ...
      confidence: 'moyenne',
      sources: [{ label: 'Service-Public — épargne salariale PEE', url: 'https://www.service-public.fr/particuliers/vosdroits/F2142' }],
  ...
  deces: [
    {
      ...
      confidence: 'moyenne',
      sources: [{ label: 'Entreprendre.Service-Public — participation', url: 'https://entreprendre.service-public.fr/vosdroits/F2141' }],
  ...
  sortie: [
    {
      ...
      confidence: 'moyenne',
      sources: [{ label: 'Service-Public — PER d’entreprise obligatoire', url: 'https://www.service-public.fr/particuliers/vosdroits/F36526/2' }],
  ...
  sortie: [
    {
      ...
      confidence: 'moyenne',
      sources: [{ label: 'Service-Public — prime de partage de la valeur', url: 'https://www.service-public.fr/particuliers/vosdroits/F35235' }],
  ...
  deces: [
    {
      ...
      confidence: 'elevee',
      sources: [{ label: 'Service-Public — PERP', url: 'https://www.service-public.fr/particuliers/vosdroits/F10259' }],
    },
  ],
};
