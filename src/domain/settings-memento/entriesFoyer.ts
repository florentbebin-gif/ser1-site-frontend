...
export const MEMENTO_FOYER_ENTRIES = [
  ...
  },
  {
    ...
    status: 'partiel',
    statusReason:
      'Les ordres civils et les options du conjoint sont sourcés ; le moteur succession actif reste centré sur les scénarios déjà exposés.',
    priority: 'critique',
    ownerPagePath: '/settings/memento',
    registryKeys: [],
    claimKeys: [],
    refIds: ['code-civil-720', 'code-civil-734-740', 'code-civil-757', 'code-civil-1094-1'],
    coverageSources: ['cadrage-externe'],
