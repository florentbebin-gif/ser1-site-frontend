...
export const MEMENTO_FOYER_ENTRIES = [
  ...
  },
  {
    ...
    status: 'partiel',
    statusReason:
      'Référentiel civil des régimes matrimoniaux, du PACS et des avantages matrimoniaux affiché en lecture seule sur la page DMTG & Succession ; le simulateur dédié reste planifié.',
    priority: 'critique',
  ...
  },
  {
    ...
    description:
      'Parts réservées aux héritiers et quotité disponible selon la composition familiale, affichées sur la page DMTG & Succession et appliquées par le moteur succession.',
    status: 'couvert',
    statusReason:
  ...
  },
  {
    ...
    status: 'couvert',
    statusReason:
      'Barème de valorisation administré sur la page DMTG & Succession via le claim settings dédié ; principes civils fondés par le Code civil et la doctrine BOFiP.',
    priority: 'critique',
    ownerPagePath: '/settings/dmtg-succession',
