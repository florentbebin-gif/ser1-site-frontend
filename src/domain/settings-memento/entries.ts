...
import { MEMENTO_EPARGNE_RETRAITE_ENTRIES } from './entriesEpargneRetraite';
import { MEMENTO_PREVOYANCE_ENTRIES } from './entriesPrevoyance';
import { MEMENTO_RETRAITE_ENTRIES } from './entriesRetraite';
...
export const MEMENTO_ENTRIES = [
  ...
  ...MEMENTO_RETRAITE_ENTRIES,
  ...MEMENTO_EPARGNE_RETRAITE_ENTRIES,
  ...MEMENTO_PREVOYANCE_ENTRIES,
