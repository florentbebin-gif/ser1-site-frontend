...
function buildPersonMembre(
  ...
  return {
    ...
    modeExercice: person.modeExercice,
    remunerationMandatPct: person.remunerationMandatPct,
    statutConventionnel: person.statutConventionnel,
    tauxPriseEnChargeCpam: person.tauxPriseEnChargeCpam,
    classePrevoyance: person.classePrevoyance,
    classeRetraite: person.classeRetraite,
    biologisteConventionne: person.biologisteConventionne,
    ancienneteCnbf: person.ancienneteCnbf,
    prestationSermentAvant2014: person.prestationSermentAvant2014,
    regimeColmarMetz: person.regimeColmarMetz,
    moyenneProduitsEtude: person.moyenneProduitsEtude,
    commissionsBrutes: person.commissionsBrutes,
    atexa: person.atexa,
    professionLiberaleReglementee: person.professionLiberaleReglementee,
    professionLiberaleCategorie: person.professionLiberaleCategorie,
    fichePaieAssimileSalarie: person.fichePaieAssimileSalarie,
...
function buildAuditPerson(membre: DossierMembre): PersonInfo {
  return {
    ...
    modeExercice: membre.modeExercice,
    remunerationMandatPct: membre.remunerationMandatPct,
    statutConventionnel: membre.statutConventionnel,
    tauxPriseEnChargeCpam: membre.tauxPriseEnChargeCpam,
    classePrevoyance: membre.classePrevoyance,
    classeRetraite: membre.classeRetraite,
    biologisteConventionne: membre.biologisteConventionne,
    ancienneteCnbf: membre.ancienneteCnbf,
    prestationSermentAvant2014: membre.prestationSermentAvant2014,
    regimeColmarMetz: membre.regimeColmarMetz,
    moyenneProduitsEtude: membre.moyenneProduitsEtude,
    commissionsBrutes: membre.commissionsBrutes,
    atexa: membre.atexa,
    professionLiberaleReglementee: membre.professionLiberaleReglementee,
    professionLiberaleCategorie: membre.professionLiberaleCategorie,
    fichePaieAssimileSalarie: membre.fichePaieAssimileSalarie,
