...
function applyThemeBootstrap(): void {
  ...
  const cachePrefix =
    themeSource === 'cabinet' ? CABINET_THEME_CACHE_KEY_PREFIX : THEME_CACHE_KEY_PREFIX;
  const cachedColors = cacheScopeKey ? readCachedColors(cachePrefix, cacheScopeKey) : null;
