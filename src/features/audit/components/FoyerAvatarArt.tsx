...
const FOYER_AVATAR_PALETTES: Record<
  `${AuditAvatarAppearance['skinTone']}-${AuditAvatarAppearance['age']}`,
  FoyerAvatarPalette
> = {
  'clair-adulte': {
    skin: '#f6cba2',
...
export function FoyerAvatarArt({ kind, clipId, appearance }: FoyerAvatarArtProps): ReactElement {
  const palette = resolveAvatarPalette(appearance);
  return (
    <>
      <circle cx={0} cy={0} r={FOYER_AVATAR_ART_RADIUS} fill={FOYER_AVATAR_BACKGROUNDS[kind]} />
      <g clipPath={`url(#${clipId})`}>{renderPortrait(kind, palette)}</g>
      <circle
        cx={0}
        cy={0}
...
function renderPortrait(kind: AuditLandingAvatarKind, palette: FoyerAvatarPalette): ReactElement {
  switch (kind) {
    case 'homme':
      return <HommePortrait palette={palette} />;
    case 'femme':
      return <FemmePortrait palette={palette} />;
    case 'garcon':
      return <GarconPortrait palette={palette} />;
    case 'fille':
      return <FillePortrait palette={palette} />;
  }
}

function resolveAvatarPalette(appearance: AuditAvatarAppearance | undefined): FoyerAvatarPalette {
  const skinTone = appearance?.skinTone === 'fonce' ? 'fonce' : 'clair';
  const age = appearance?.age === 'senior' ? 'senior' : 'adulte';
  return FOYER_AVATAR_PALETTES[`${skinTone}-${age}`];
}

function HommePortrait({ palette }: { palette: FoyerAvatarPalette }): ReactElement {
  return (
    <>
      ...
      <path d="M-19 22 L19 22 L21 90 L-21 90 Z" fill={palette.skin} />
      <path
        d="M-100 112 L-100 60 C-84 40 -52 42 -22 56 L0 80 L22 56 C52 42 84 40 100 60 L100 112 Z"
        fill="#3b332e"
      />
      <ellipse cx={-47} cy={-16} rx={9} ry={13} fill={palette.skin} />
      <ellipse cx={47} cy={-16} rx={9} ry={13} fill={palette.skin} />
      <path
      ...
      />
      <path d="M-17 0 C-9 7 9 7 17 0 C9 11 -9 11 -17 0 Z" fill={palette.hairDark} />
      <path d="M-1 -12 L-5 4 Q0 7 5 4 L1 -12 Z" fill={palette.skinShadow} />
...
function FemmePortrait({ palette }: { palette: FoyerAvatarPalette }): ReactElement {
  return (
    <>
      <path
      ...
      <path
        ...
        fill={palette.hair}
      />
      <ellipse cx={4} cy={-80} rx={21} ry={18} fill={palette.hair} />
      <ellipse cx={4} cy={-62} rx={11} ry={7} fill={palette.hairDark} />
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M-17 24 L17 24 L19 92 L-19 92 Z" fill={palette.skin} />
      ...
      <path
        ...
        fill={palette.skin}
      />
      <ellipse cx={43} cy={-10} rx={8} ry={12} fill={palette.skin} />
...
function FillePortrait({ palette }: { palette: FoyerAvatarPalette }): ReactElement {
  return (
    <>
      <path
        ...
        fill={palette.hair}
      />
      <ellipse cx={2} cy={-64} rx={15} ry={13} fill={palette.hair} />
      <ellipse cx={2} cy={-50} rx={9} ry={6} fill={palette.hairDark} />
      <path d="M-16 24 L16 24 L18 90 L-18 90 Z" fill={palette.skin} />
      ...
      <path
        ...
        fill={palette.skin}
      />
      <ellipse cx={-42} cy={-6} rx={7} ry={11} fill={palette.skin} />
      <ellipse cx={42} cy={-6} rx={7} ry={11} fill={palette.skin} />
      <path
        d="M-42 -20 C-44 -54 -22 -68 2 -68 C30 -68 44 -52 42 -22 C36 -44 22 -50 8 -48 C24 -36 0 -28 -20 -33 C-32 -36 -38 -40 -42 -20 Z"
        fill={palette.hair}
      />
      <path d="M40 -22 C46 6 40 28 31 36 C40 14 38 -8 35 -22 Z" fill={palette.hair} />
      <path
      ...
      <circle cx={-26} cy={8} r={6} fill={palette.blush} opacity={0.45} />
      <circle cx={26} cy={8} r={6} fill={palette.blush} opacity={0.45} />
    </>
  );
}

function GarconPortrait({ palette }: { palette: FoyerAvatarPalette }): ReactElement {
  return (
    <>
      <path d="M-17 22 L17 22 L19 88 L-19 88 Z" fill={palette.skin} />
      ...
      <path d="M-46 -20 C-54 -62 -30 -86 0 -86 C30 -86 54 -62 46 -20 Z" fill={palette.hair} />
      <path
        d="M-40 -22 C-42 24 -22 46 0 46 C25 46 43 22 42 -24 C42 -52 22 -68 0 -68 C-24 -68 -40 -50 -40 -22 Z"
        fill={palette.skin}
      />
      <ellipse cx={-40} cy={-6} rx={7} ry={11} fill={palette.skin} />
      <ellipse cx={40} cy={-6} rx={7} ry={11} fill={palette.skin} />
      <path
        d="M-42 -28 C-46 -54 -22 -66 2 -66 C32 -66 48 -54 47 -26 C40 -50 22 -52 6 -50 C-8 -49 -26 -46 -42 -28 Z"
        fill={palette.hair}
      />
      <path d="M30 -64 C48 -78 60 -66 52 -50 C48 -62 38 -64 30 -60 Z" fill={palette.hair} />
      <path
      ...
      <circle cx={-25} cy={6} r={5.5} fill={palette.blush} opacity={0.4} />
      <circle cx={25} cy={6} r={5.5} fill={palette.blush} opacity={0.4} />
    </>
  );
}
