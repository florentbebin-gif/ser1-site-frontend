...
function buildBeneficiaries(beneficiaries: ChainageStep['beneficiaries']) {
...
export function buildSuccessionChainageExportPayload({
  ...
  return {
    ...
    step1:
      displayUsesChainage && chainageAnalysis.step1
        ? buildStepPayload(
        ...
        : null,
    step2:
      displayUsesChainage && chainageAnalysis.step2
        ? buildStepPayload(
        ...
        : null,
    societeAcquets:
      displayUsesChainage && chainageAnalysis.societeAcquets
        ? {
    ...
    participationAcquets:
      displayUsesChainage && chainageAnalysis.participationAcquets
        ? {
        ...
        : null,
    interMassClaims:
      displayUsesChainage && chainageAnalysis.interMassClaims
        ? {
        ...
        : null,
    affectedLiabilities:
      displayUsesChainage && chainageAnalysis.affectedLiabilities
        ? {
        ...
        : null,
    preciput:
      displayUsesChainage && chainageAnalysis.preciput
        ? {
