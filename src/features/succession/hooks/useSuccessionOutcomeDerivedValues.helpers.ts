...
import type { InsuranceBeneficiaryLine } from './useSuccessionOutcomeInsurance.helpers';

export {
  mergeInsuranceBeneficiaryLines,
  type InsuranceBeneficiaryLine,
  type InsuranceSourceKind,
} from './useSuccessionOutcomeInsurance.helpers';
