...
export function TresoCompanyFinancialsModal({
  ...
  return (
    <SimModalShell
      ...
      modalClassName="sim-modal--md ts-company-financials-modal"
      bodyClassName="ts-company-modal__body ts-company-financials-modal__body"
      footer={
    ...
    >
      <div className="ts-company-financials-modal__panel sim-modal-section-panel">
        <div className="ts-modal-grid">
          ...
          >
            <input
              ...
              onChange={(event) =>
                onChange({ reservesInitial: parseEuroInput(event.target.value) })
              }
            />
            <span className="sim-field__unit ts-unit">€</span>
          </SimFieldShell>
