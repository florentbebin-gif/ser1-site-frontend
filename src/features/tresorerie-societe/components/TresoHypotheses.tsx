        ...
        <div className="ts-hypotheses__body">
          ...
          <section className="ts-hyp-section">
            ...
            <ul className="ts-hyp-list">
              <li>
                IS calculé selon la formule progressive : taux réduit sur la tranche ≤ seuil,
                taux normal au-delà. Barème lu depuis les paramètres fiscaux (CGI art. 219).
              </li>
              <li>
                Base IS clampée à 0 — report de pertes hors scope V1.
          ...
          <section className="ts-hyp-section">
            ...
            <ul className="ts-hyp-list">
              <li>
                ...
                (preuve : formule M21 sheet31 du modèle de référence).
              </li>
              <li>
          ...
          <section className="ts-hyp-section">
            ...
            <ul className="ts-hyp-list">
              ...
              <li>
                Revenus calculés au prorata des mois productifs de l'année civile (CGI art. 38 quater).
              </li>
              <li>
                En cas de répétition au terme, le délai de jouissance se réapplique au début de chaque nouveau cycle.
              </li>
            </ul>
          </section>
          ...
          <section className="ts-hyp-section">
            ...
            <ul className="ts-hyp-list">
              ...
              <li>
                Convention Option A : les dividendes sortent en brut unique dans les flux trésorerie.
                Le PFU est calculé pour affichage (revenus nets associés) mais n'entre pas
                une seconde fois dans la trésorerie nette.
              </li>
            </ul>
          </section>
          ...
          <section className="ts-hyp-section">
            ...
            <ul className="ts-hyp-list">
              ...
              <li>
                Conditions minimales indicatives : taux de détention ≥ 5 %,
                durée de conservation ≥ 2 ans.
              </li>
              <li>
                Quote-part de frais et charges (QPFC) : 5 % (standard) ou 1 % (groupe fiscal intégré),
                lue depuis les paramètres fiscaux.
              </li>
            </ul>
          </section>
          ...
          <section className="ts-hyp-section">
            ...
            <ul className="ts-hyp-list">
              <li>
                Société à l'IR (SARL de famille) — disponible prochainement.
                La transparence fiscale IR requiert un couplage avec un moteur IR complet.
              </li>
            </ul>
          </section>

          <p className="ts-hyp-disclaimer">
            Ce simulateur est un outil d'aide à l'analyse patrimoniale pour le CGP.
            Il ne remplace pas un expert-comptable ni un conseil juridique spécialisé.
          </p>
        </div>
      )}
    </div>
