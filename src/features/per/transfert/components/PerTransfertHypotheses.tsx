    ...
    <section className="per-transfert-hypotheses">
      ...
      {open ? (
        <ul className="per-transfert-hypotheses__list">
          <li>Le scénario Conserver maintient le contrat actuel avec les performances, versements et revalorisations saisis.</li>
          <li>Le scénario Transférer applique les frais sortants puis les frais d’entrée du nouveau PER, sans fiscalité au transfert.</li>
          <li>La table du nouveau PER est TGH05 ou TGF05 selon le sexe assuré, sauf cas spécifique des contrats en points.</li>
