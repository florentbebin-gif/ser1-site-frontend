...
export type TransferAllowedRule = 'free' | 'after_leaving_company' | 'every_3_years_if_active' | 'unknown';
...
export const TRANSFER_RULES_BY_TYPE = {
  PERIN: {
    ...
    details: 'Le transfert est possible selon les conditions du plan, avec contrôle des frais sortants et de la date du premier versement.',
  },
  PERP: {
    rule: 'free',
    label: 'Transférable vers un PER individuel',
    legalRef: 'Art. L224-40 C. mon. fin.',
    details: 'Les droits des anciens PERP peuvent être transférés vers un PER, sous réserve des informations communiquées par l’assureur sortant.',
  },
  MADELIN: {
    rule: 'free',
    label: 'Transférable vers un PER individuel',
    legalRef: 'Art. L224-40 C. mon. fin.',
    details: 'Les droits Madelin retraite peuvent être transférés vers un PER et sont suivis dans le compartiment volontaire.',
  },
  PER_POINTS: {
    rule: 'free',
    label: 'Transférable selon la valeur communiquée',
    legalRef: 'Art. L224-40 C. mon. fin. et notice du régime',
    details: 'Pour les contrats en points, la valeur de transfert nette doit être vérifiée sur le relevé ou auprès de l’assureur.',
  },
  ARTICLE83: {
    rule: 'after_leaving_company',
    label: 'Transférable après départ de l’entreprise',
    legalRef: 'Art. L224-40 C. mon. fin.',
    details: 'Le transfert n’est pas possible tant que le bénéficiaire reste tenu d’adhérer au contrat de l’entreprise.',
  },
  PEROB: {
    rule: 'after_leaving_company',
    label: 'Transférable après départ de l’entreprise',
    legalRef: 'Art. L224-40 C. mon. fin.',
    details: 'Le régime est aligné sur les droits obligatoires : transfert possible lorsque l’adhésion n’est plus obligatoire.',
  },
  PERCO: {
