      ...
      <main className="home-main" data-testid="home-main">
        <section className="home-hero" data-testid="home-hero-section">
          ...
          <p className="hero-subtitle" data-testid="home-hero-subtitle">
            Analyser la situation patrimoniale, puis la projeter et définir une nouvelle stratégie
            adaptée.
          </p>
          <Link to="/audit" className="hero-tile" data-testid="home-audit-link">
            <div className="hero-tile-content">
              ...
              <div className="hero-tile-chevron">
                <IconChevron />
              </div>
            </div>
          </Link>
        ...
        <section className="home-tools" data-testid="home-tools-section">
          <h2 className="tools-title" data-testid="home-tools-title">
            SIMULATEURS
          </h2>
          <div className="tools-card">
            <div className="tools-grid" data-testid="home-tools-grid">
              ...
              <ToolTile
                ...
                testId="home-tool-epargne-retraite"
              />
              <ToolTile
                to="/sim/succession"
                icon={<IconTransfer />}
                title="Droits de succession"
                testId="home-tool-droits-succession"
              />
              <ToolTile
                to="/sim/epargne-salariale"
                icon={<IconWallet />}
                title="Épargne salariale"
                testId="home-tool-epargne-salariale"
              />
              <ToolTile
                to="/sim/credit"
                icon={<IconPercent />}
                title="Crédit"
                testId="home-tool-credit"
              />
              <ToolTile
                to="/sim/tresorerie-societe"
                icon={<IconBuilding />}
                title="Trésorerie société"
                testId="home-tool-tresorerie-societe"
              />
              <ToolTile
                to="/sim/prevoyance"
                icon={<IconShield />}
                title="Prévoyance"
                testId="home-tool-prevoyance"
              />
            </div>
          </div>
        </section>
  ...
  return (
    <Link to={to} className="tool-tile" data-testid={testId}>
      <div className="tool-tile-content">
        ...
        <div className="tool-tile-chevron">
          <IconChevronSmall />
        </div>
      </div>
    </Link>
