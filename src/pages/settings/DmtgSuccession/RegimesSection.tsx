...
export default function RegimesSection(): ReactElement {
  ...
  return (
    <section className="settings-memento-entry-section settings-dmtg-entry-section">
      <h6>Régimes matrimoniaux & PACS</h6>
      <p className="dmtg-intro">
        Référentiel civil en lecture seule : situations familiales et régimes matrimoniaux sont
        distingués.
      </p>
      ...
      <div className="income-tax-block dmtg-block--mt4">
        ...
        <p className="dmtg-desc--flush">
          Par défaut : séparation de biens. Option : indivision des acquêts. Le partenaire pacsé est
          exonéré de droits de succession (loi TEPA 2007).
        </p>
      </div>
    </section>
  );
