 ...
 */
export function computeCapitalDecesPeriod(params: LoanParams, crdDebut: number): number {
 ...
 */
export function aggregateCapitalDecesGlobal(loansSchedules: ScheduleRow[][]): number[] {
