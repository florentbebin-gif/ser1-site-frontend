...
import type { TresoInputsV2 } from '../migrations/compatTypes';
  ...
  return {
    ...
    company: {
      ...
      associates: inputs.company.associates.map((associate) =>
        associate.profile || associate.kind === 'pm'
          ? associate
          : {
              ...associate,
              ...
              profile: {
                ...
                projectionStartYear:
                  inputs.company.projectionStartYear ?? inputs.foyer.projectionStartYear,
              },
            },
      ),
    },
...
describe('simulateTresorerie — modèle société v2', () => {
  ...
  it('constitue le CCA initial et annuel par associé puis rembourse le créancier déclaré', () => {
    ...
    expect(rows[1].revenusParAssocie).toEqual(
          ...
          associates: [
            {
              ...
              remuneration: { source: 'holding', loadedAnnualCost: 0, socialChargeRate: 0.4 },
            },
          ],
        },
      }),
