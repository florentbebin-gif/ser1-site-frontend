-- Correction Lot 5 prévoyance : remplacer les URLs racines par des pages catégorielles.
-- Export préalable attendu : .cache/prevoyance-sources-before-lot5-correction.json

WITH regime_sources(code, sources) AS (
  VALUES
    ('salarie-cpam', $prevoyance_sources_lot5_fix_salarie_cpam$
{
  "references": [
    {
      "organisme": "Ameli",
      "titre": "Arrêt de travail — Salarié secteur privé — CPAM",
      "url": "https://www.ameli.fr/assure/remboursements/indemnites-journalieres-maladie-maternite-paternite/arret-maladie",
    ...
    },
    {
      ...
      "url": "https://www.ameli.fr/assure/remboursements/pensions-allocations-rentes/deces-proche-capital-deces",
      "dateConsultation": "2026-06-06",
      "rubrique": "Décès",
      "valeursCouvertes": [
        "deces"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Salarié secteur privé — CPAM (salarie-cpam)."
}
$prevoyance_sources_lot5_fix_salarie_cpam$::jsonb),
    ('salarie-msa', $prevoyance_sources_lot5_fix_salarie_msa$
{
  "references": [
    {
      "organisme": "MSA",
      "titre": "Arrêt de travail — Salarié agricole — MSA",
      "url": "https://www.msa.fr/lfp/sante/arret-de-travail",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.msa.fr/lfp/sante/invalidite",
      "dateConsultation": "2026-06-06",
      "rubrique": "Invalidité",
      "valeursCouvertes": [
        "invalidite"
    ...
    },
    {
      ...
      "url": "https://www.msa.fr/lfp/sante/capital-deces",
      "dateConsultation": "2026-06-06",
      "rubrique": "Décès",
      "valeursCouvertes": [
        "deces"
    ...
    },
    {
      ...
      "url": "https://www.msa.fr/lfp/employeur/cotisations-sociales",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Salarié agricole — MSA (salarie-msa)."
}
$prevoyance_sources_lot5_fix_salarie_msa$::jsonb),
    ('ssi-artisan-commercant', $prevoyance_sources_lot5_fix_ssi_artisan_commercant$
{
  "references": [
    {
      "organisme": "Ameli / URSSAF",
      "titre": "Arrêt de travail — Artisan / commerçant — SSI",
      "url": "https://www.ameli.fr/assure/remboursements/indemnites-journalieres-maladie-maternite-paternite/indemnites-journalieres-artisans-commercants",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.ameli.fr/assure/droits-demarches/invalidite-handicap/invalidite-travailleur-independant",
      "dateConsultation": "2026-06-06",
      "rubrique": "Invalidité",
      "valeursCouvertes": [
        "invalidite"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Artisan / commerçant — SSI (ssi-artisan-commercant)."
}
$prevoyance_sources_lot5_fix_ssi_artisan_commercant$::jsonb),
    ('cnavpl', $prevoyance_sources_lot5_fix_cnavpl$
{
  "references": [
    {
      "organisme": "CNAVPL",
      "titre": "Arrêt de travail — Profession libérale — socle CNAVPL",
      "url": "https://www.cnavpl.fr/regime-invalidite-deces",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.cnavpl.fr/cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Profession libérale — socle CNAVPL (cnavpl)."
}
$prevoyance_sources_lot5_fix_cnavpl$::jsonb),
    ('cipav', $prevoyance_sources_lot5_fix_cipav$
{
  "references": [
    {
      "organisme": "CIPAV",
    ...
    },
    {
      ...
      "url": "https://www.lacipav.fr/mes-droits-et-demarches/cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Profession libérale réglementée — CIPAV (cipav)."
}
$prevoyance_sources_lot5_fix_cipav$::jsonb),
    ('carpimko', $prevoyance_sources_lot5_fix_carpimko$
{
  "references": [
    {
      "organisme": "CARPIMKO",
    ...
    },
    {
      ...
      "url": "https://www.carpimko.com/je-minstalle/mes-cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Auxiliaire médical — CARPIMKO (carpimko)."
}
$prevoyance_sources_lot5_fix_carpimko$::jsonb),
    ('carmf', $prevoyance_sources_lot5_fix_carmf$
{
  "references": [
    {
      "organisme": "CARMF",
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Médecin — CARMF (carmf)."
}
$prevoyance_sources_lot5_fix_carmf$::jsonb),
    ('carcdsf-dentiste', $prevoyance_sources_lot5_fix_carcdsf_dentiste$
{
  "references": [
    {
      "organisme": "CARCDSF",
      "titre": "Arrêt de travail — Chirurgien-dentiste — CARCDSF",
      "url": "https://www.carcdsf.fr/prevoyance",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.carcdsf.fr/invalidite-deces",
      "dateConsultation": "2026-06-06",
      "rubrique": "Invalidité",
      "valeursCouvertes": [
        "invalidite"
    ...
    },
    {
      ...
      "url": "https://www.carcdsf.fr/cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Chirurgien-dentiste — CARCDSF (carcdsf-dentiste)."
}
$prevoyance_sources_lot5_fix_carcdsf_dentiste$::jsonb),
    ('carcdsf-sagefemme', $prevoyance_sources_lot5_fix_carcdsf_sagefemme$
{
  "references": [
    {
      "organisme": "CARCDSF",
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Sage-femme — CARCDSF (carcdsf-sagefemme)."
}
$prevoyance_sources_lot5_fix_carcdsf_sagefemme$::jsonb),
    ('cavp', $prevoyance_sources_lot5_fix_cavp$
{
  "references": [
    {
      "organisme": "CAVP",
      "titre": "Arrêt de travail — Pharmacien — CAVP",
      "url": "https://www.cavp.fr/votre-prevoyance",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.cavp.fr/vos-cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Pharmacien — CAVP (cavp)."
}
$prevoyance_sources_lot5_fix_cavp$::jsonb),
    ('carpv', $prevoyance_sources_lot5_fix_carpv$
{
  "references": [
    {
      "organisme": "CARPV",
      "titre": "Arrêt de travail — Vétérinaire — CARPV",
      "url": "https://www.carpv.fr/prevoyance",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.carpv.fr/cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Vétérinaire — CARPV (carpv)."
}
$prevoyance_sources_lot5_fix_carpv$::jsonb),
    ('cavec', $prevoyance_sources_lot5_fix_cavec$
{
  "references": [
    {
      "organisme": "CAVEC",
      "titre": "Arrêt de travail — Expert-comptable — CAVEC",
      "url": "https://www.cavec.fr/prevoyance",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.cavec.fr/cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Expert-comptable — CAVEC (cavec)."
}
$prevoyance_sources_lot5_fix_cavec$::jsonb),
    ('cprn', $prevoyance_sources_lot5_fix_cprn$
{
  "references": [
    {
      "organisme": "CPRN",
      "titre": "Arrêt de travail — Notaire — CPRN",
      "url": "https://www.cprn.fr/prevoyance",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.cprn.fr/cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Notaire — CPRN (cprn)."
}
$prevoyance_sources_lot5_fix_cprn$::jsonb),
    ('cavom', $prevoyance_sources_lot5_fix_cavom$
{
  "references": [
    {
      "organisme": "CAVOM",
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Officier ministériel — CAVOM (cavom)."
}
$prevoyance_sources_lot5_fix_cavom$::jsonb),
    ('cavamac', $prevoyance_sources_lot5_fix_cavamac$
{
  "references": [
    {
      "organisme": "CAVAMAC",
      "titre": "Arrêt de travail — Agent général d'assurance — CAVAMAC",
      "url": "https://www.cavamac.fr/prevoyance",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.cavamac.fr/cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Agent général d'assurance — CAVAMAC (cavamac)."
}
$prevoyance_sources_lot5_fix_cavamac$::jsonb),
    ('cnbf', $prevoyance_sources_lot5_fix_cnbf$
{
  "references": [
    {
      "organisme": "CNBF",
      "titre": "Arrêt de travail — Avocat — CNBF",
      "url": "https://www.cnbf.fr/fr/prevoyance",
      "dateConsultation": "2026-06-06",
      "rubrique": "Arrêt de travail",
      "valeursCouvertes": [
        "arret"
    ...
    },
    {
      ...
      "url": "https://www.cnbf.fr/fr/cotisations",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Avocat — CNBF (cnbf)."
}
$prevoyance_sources_lot5_fix_cnbf$::jsonb),
    ('msa-exploitant', $prevoyance_sources_lot5_fix_msa_exploitant$
{
  "references": [
    {
      "organisme": "MSA",
    ...
    },
    {
      ...
      "url": "https://www.msa.fr/lfp/sante/invalidite-exploitants",
      "dateConsultation": "2026-06-06",
      "rubrique": "Invalidité",
      "valeursCouvertes": [
        "invalidite"
    ...
    },
    {
      ...
      "url": "https://www.msa.fr/lfp/sante/capital-deces-exploitants",
      "dateConsultation": "2026-06-06",
      "rubrique": "Décès",
      "valeursCouvertes": [
        "deces"
    ...
    },
    {
      ...
      "url": "https://www.msa.fr/lfp/exploitant/cotisations-sociales",
      "dateConsultation": "2026-06-06",
      "rubrique": "Cotisations",
      "valeursCouvertes": [
        "cotisations"
  ...
  "noteAdmin": "Migration 20260606000300 : remplacement des URLs racines par des pages catégorielles pour Exploitant agricole — MSA AMEXA (msa-exploitant)."
}
$prevoyance_sources_lot5_fix_msa_exploitant$::jsonb)
)
